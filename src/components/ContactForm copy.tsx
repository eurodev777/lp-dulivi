	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			toast({
				...
				description: 'Tivemos um problema ao enviar seus dados. Tente novamente.',
				variant: 'destructive',
			})
		}
	}
			...
			<div className='lg:container px-6 mx-auto !max-w-2xl'>
				<div className='text-center mb-12 animate-fade-in'>
					...
					<p className='text-lg text-muted-foreground'>
						Fale com nossos especialistas e descubra como a Dulivi pode revolucionar
						seu negócio
					</p>
				</div>
				...
				>
					...
					>
						Criar delivery agora <Send className='sm:ml-2 h-5 w-5' />
					</Button>
