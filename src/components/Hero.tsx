...
export const Hero = () => {
  ...
  return (
    <section id="inicio" className="relative lg:min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-background via-background to-primary/5 py-20">
        ...
        <div className="text-center space-y-8 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
            ...
            <Button 
              size="lg" 
              variant="outline"
              onClick={() => window.open('https://menu-dulivi.netlify.app/caldinho-da-ashley', '_blank')}
